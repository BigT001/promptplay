...
export async function GET(
  ...
  try {
    ...
    console.error("Error in GET /api/projects/[projectId]/characters/[characterId]:", error)
...
export async function PUT(
  ...
  try {
    ...
    console.error("Error in PUT /api/projects/[projectId]/characters/[characterId]:", error)
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    console.error("Error in DELETE /api/projects/[projectId]/characters/[characterId]:", error)
    return NextResponse.json(
